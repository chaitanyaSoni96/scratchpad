...
func TestAcceptsGzip(t *testing.T) {
	cases := map[string]bool{
		...
		"gzip;q=-0.1":                  false,
		"gzip;q=1.1":                   false,
		"gzip;q=0, gzip;q=0.4":         true,
		"gzip;q=0.8, gzip;q=0.2":       true,
		"*;q=0.5":                      true,
		"*;q=0":                        false,
		"*;q=0.8, gzip;q=0":            false,
		"*;q=0, gzip;q=0.2":            true,
		"*;q=0.8, gzip;q=bad":          true,
		"*;q=0.8, gzip;q=.5":           true,
		"*;q=0.8, gzip;q=0.0000":       true,
		"*;q=0.8, gzip;q=1.001":        true,
		"gzip;level=9;q=0.5":           true,
